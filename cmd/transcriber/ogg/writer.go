...
func (i *Writer) writeHeaders() error {
	// ID Header
...
func (i *Writer) createPage(payload []uint8, headerType uint8, granulePos uint64, pageIndex uint32) []byte {
...
func (i *Writer) writeToStream(p []byte) error {
	if i.stream == nil {
